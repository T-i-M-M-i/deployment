{ config, pkgs, ... }:
{
  ...
  ## nix-serve fails with current nixos-unstable: https://github.com/edolstra/nix-serve/issues/28
  ## This overlay seems to solve it:
  nixpkgs.overlays = [ (_: super: { nix-serve = super.nix-serve.override { nix = super.nix_2_3; }; } ) ];
